...
export MODEL="G935F"
export KERNEL_VERSION="MoRoKernel-S7-Nougat-v0.7"
export REVISION="RC"
...
FUNC_BUILD_FLASHABLES()
{
	...
	cd ..
	cd tar
	tar cf $KERNEL_VERSION-$MODEL-$REVISION$KBUILD_VERSION.tar boot.img && ls -lh $KERNEL_VERSION-$MODEL-$REVISION$KBUILD_VERSION.tar
	rm boot.img
