...
export BUILD_CROSS_COMPILE=/home/moro/kernel/toolchains/aarch64-linux-android-5.x/bin/aarch64-linux-android-
...
export KERNEL_VERSION="MoRoKernel-$MODEL-N-v1.6.2"
export REVISION="RC"
