...
cortexbrain_background_process=$(cat /res/synapse/moro/cortexbrain_background_process);
cortexbrain_kernel=$(cat /res/synapse/moro/cortexbrain_kernel);
cortexbrain_system=$(cat /res/synapse/moro/cortexbrain_system);
cortexbrain_wifi_auto=$(cat /res/synapse/moro/cortexbrain_wifi_auto);
cortexbrain_media_manager=$(cat /res/synapse/moro/cortexbrain_media_manager);
cortexbrain_nmi_auto=$(cat /res/synapse/moro/cortexbrain_nmi_auto);
cortexbrain_doze_auto=$(cat /res/synapse/moro/cortexbrain_doze_auto);
cortexbrain_alpm_auto=$(cat /res/synapse/moro/cortexbrain_alpm_auto);
cortexbrain_lux=$(cat /res/synapse/moro/cortexbrain_lux);
